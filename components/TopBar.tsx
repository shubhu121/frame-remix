  ...
  return (
    <div className="w-full max-w-sm sm:max-w-md mx-auto flex flex-col gap-2.5">
      ...
      <div className="flex items-center justify-between gap-2 w-full">
        ...
        {/* Alternate Component View Link */}
        <Link
          href="/treatment-grid"
          title="Open TreatmentGrid View"
          className={`flex items-center gap-1 px-2.5 py-1.5 rounded-full text-[11px] font-medium transition-all duration-150 cursor-pointer ${
            isDark
              ? 'bg-zinc-900/90 text-zinc-400 hover:text-white hover:bg-zinc-800 border border-zinc-800/80 shadow-xs'
              : 'bg-white text-zinc-600 hover:text-black hover:bg-zinc-100 border border-zinc-200/80 shadow-xs'
          }`}
        >
